...
<body>
          <head>
                  ...
                  <body class="profile-page">
                    <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
                      <div class="container">
                        <div class="navbar-translate">
                          <a class="navbar-brand" href="#" target="_blank">سپهر</a>
                    ...
                    <div class="page-header header-filter" data-parallax="true" style="background-image:url('./bback.jpg');"></div>
                        ...
                        <div class="container">
                          <div class="row">
                            <div class="col-md-6 ml-auto mr-auto">
                              <div class="profile">
                                <div class="avatar">
                                  <img src="https://avatars.githubusercontent.com/u/98479885?s=48&v=4" alt="Circle Image" class="img-raised rounded-circle img-fluid">
                                </div>
                                <div class="name">
                                  <h3 class="title">سپهر</h3>
                                  <h6>برنامه نویس و علاقه مند به دنیای کامپیوتر</h6>
                            ...
                            <div class="col-md-6 ml-auto mr-auto">
                              <div class="profile-tabs">
                                <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link" href="#written" role="tab" data-toggle="tab">
                                      <i class="fa-regular fa-folder-grid"></i>
                                      نوشته
                                    </a>
                                  </li>
                                  <li class="nav-item">
                          ...
                          <div class="tab-content tab-space">
                            <div style="direction: ltr;" class="tab-pane active text-center gallery" id="studio">
                              <div class="row">
                            ...
                            <!--  -->
                            <div class="tab-pane text-center gallery" id="written">
                              <div class="row">
                                <div class="col-md-3 center" style="margin: auto;">
<center>
          ...
          <div class="blog-container">
                    ...
                    <div class="blog-body">
                      <div class="blog-title">
                        <h1><a href="./single.html">سلام دنیا</a></h1>
                      </div>
                    ...
                    <center><li class="published-date"><i class="fa-regular fa-calendar"></i> ۱ اسفند ۹۸</li></center>
                        </ul>
                      </div>
                    </div>
          ...
          <div class="blog-container">
                            ...
                            <div class="tab-pane text-center gallery" id="about">
                              <div class="row"><center></center>
                                <div class="col-md-3 ml-auto">
                                 ...
                                 <p id="aboutp">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
                                 
                                </div></center>

                                <div class="col-md-3 mr-auto">
                              <img style="width: 90%;border-radius: 100%;background-color: black;" id="logo-imgg" src="./us.png" alt="logo">
                    ...
                    <footer class="footer text-center ">
                      <p>طراحی شده توسط سپهر با قالب <a href="#" style="color: #FD7014;font-family: Pfont;">پروا</a>. ۲۰۲۰- ۲۰۲۳</p>
                    </footer>
